...
<div class = "outside-main">
    <?php if (isset($_SESSION['errorsDoesNotExists']) && is_array($_SESSION['errorsDoesNotExists'])): ?>
    ...
    <?php endif; ?>
    <?php if (isset($_SESSION['errorsStudentRecorded']) && is_array($_SESSION['errorsStudentRecorded'])): ?>
    ...
    <?php endif; ?>
    <?php if (isset($_SESSION['errorsCreateNewDate']) && is_array($_SESSION['errorsCreateNewDate'])): ?>
        <div id="addErrorMsg" class="alert alert-warning alert-dismissible fade show addErrorMsg" role="alert" style = "display:'block';">Current request is not available. Please add a new date.
            
            <button type="button" class="btn btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        <?php unset($_SESSION['errorsCreateNewDate']); ?>
    <?php endif; ?>
    <?php if (isset($_SESSION['errors2']) && is_array($_SESSION['errors2'])): ?>
        <div id="addErrorMsg" class="alert alert-warning alert-dismissible fade show addErrorMsg" role="alert" style = "display:'block';">Date has already been created.
